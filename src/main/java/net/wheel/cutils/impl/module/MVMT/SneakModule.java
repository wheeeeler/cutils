...
public final class SneakModule extends Module {
    ...
    public final Value<Mode> mode = new Value<Mode>("Mode", new String[] { "Mode", "M" }, "The sneak mode to use",
            Mode.VANILLA);

    public SneakModule() {
        super("SneakModule", new String[] { "snk" }, "i WAS hiding", "NONE", -1, ModuleType.MVMT);
    }
