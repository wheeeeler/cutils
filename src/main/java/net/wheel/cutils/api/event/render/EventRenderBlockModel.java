...
public class EventRenderBlockModel extends EventCancellable {
    ...
    public EventRenderBlockModel(IBlockAccess blockAccess, IBakedModel bakedModel, IBlockState blockState,
            BlockPos blockPos, BufferBuilder bufferBuilder, boolean checkSides, long rand) {
