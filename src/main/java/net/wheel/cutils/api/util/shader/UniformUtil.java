...
public final class UniformUtil {
    ...
    private static void showWarning(String message) {
        if (canWarn) {
            canWarn = false;
            crack.INSTANCE.getLogger().log(Level.WARNING, message + ". No further warning will be shown");
        }
    }
    ...
    public static void set(int loc, int matrixSize, boolean transpose, FloatBuffer val) {
        switch (matrixSize) {
            ...
            case 23:
                if (usingArbShaders()) {
                    showWarning("2x3 matrix uniform with location " + loc
                            + " not set since this feature is not available with ARB shaders; OpenGL 2.1 required");
                } else {
            ...
            case 32:
                if (usingArbShaders()) {
                    showWarning("3x2 matrix uniform with location " + loc
                            + " not set since this feature is not available with ARB shaders; OpenGL 2.1 required");
                } else {
            ...
            case 24:
                if (usingArbShaders()) {
                    showWarning("2x4 matrix uniform with location " + loc
                            + " not set since this feature is not available with ARB shaders; OpenGL 2.1 required");
                } else {
            ...
            case 42:
                if (usingArbShaders()) {
                    showWarning("4x2 matrix uniform with location " + loc
                            + " not set since this feature is not available with ARB shaders; OpenGL 2.1 required");
                } else {
            ...
            case 34:
                if (usingArbShaders()) {
                    showWarning("3x4 matrix uniform with location " + loc
                            + " not set since this feature is not available with ARB shaders; OpenGL 2.1 required");
                } else {
            ...
            case 43:
                if (usingArbShaders()) {
                    showWarning("4x3 matrix uniform with location " + loc
                            + " not set since this feature is not available with ARB shaders; OpenGL 2.1 required");
                } else {
